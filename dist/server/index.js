...
const script = `document.addEventListener("click",e=>{let a=e.target.closest("[data-a]");if(a){let q=a.closest(".q");q.className="q "+a.dataset.a;}let c=e.target.closest(".cause");if(c){document.querySelectorAll(".cause").forEach(x=>x.classList.remove("active"));c.classList.add("active");let d=document.querySelector(".detail");d.className="detail "+c.dataset.tone;d.innerHTML="<b>"+c.dataset.name+"</b><p>"+c.dataset.ev+"</p>";}})`;
