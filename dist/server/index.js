...
const mobileStyle = `@media(max-width:800px){html,body{max-width:100%;overflow-x:hidden}body{-webkit-text-size-adjust:100%}.shell{display:block;width:100%}.side{position:sticky;top:0;z-index:50;width:100%;height:auto;min-height:60px;padding:9px 12px;display:flex;flex-direction:row;align-items:center;gap:8px;border-bottom:1px solid #29483f;box-shadow:0 8px 24px rgb(6 31 24/18%)}.brand{display:flex;align-items:center;min-width:0;margin:0 auto 0 0;font-size:10px;line-height:1.2}.brand i{flex:0 0 38px;width:38px;height:38px;margin-right:8px;border-radius:11px}.side nav{display:flex;flex:0 0 auto;gap:3px}.side nav small,.foot{display:none}.nav a{display:inline-flex;align-items:center;min-height:40px;margin:0;padding:8px 9px;font-size:11px;white-space:nowrap}.main{grid-column:auto;min-width:0;width:100%;padding:20px 12px 44px}.main>*{max-width:100%}.head{display:block;margin-bottom:19px}.head>div{min-width:0}.head h1{max-width:100%;margin-top:6px;font-size:clamp(24px,7vw,29px);line-height:1.12;overflow-wrap:anywhere}.head p{margin:0;font-size:13px;line-height:1.5}.summary,.metrics{grid-template-columns:repeat(2,minmax(0,1fr));gap:10px}.summary{padding:10px}.summary>div{min-width:0;padding:8px}.summary strong,.metric strong{font-size:23px}.metric{min-width:0;min-height:118px;padding:15px}.metric small{display:block;font-size:10px;line-height:1.35}.grid,.cgrid,.time-chart-grid{grid-template-columns:1fr;gap:10px;margin:10px 0}.panel,.card,.sidecard{min-width:0;padding:16px;border-radius:13px}.toolbar{display:block;margin:15px 0 19px}.search{width:100%;min-width:0;min-height:44px;margin-bottom:9px}.filters{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));width:100%;gap:4px}.filters button{min-width:0;min-height:40px;padding:7px 4px;border-radius:7px}.clause-list{gap:18px!important}.clause-summary{flex-direction:column;align-items:stretch!important;gap:12px!important;padding:15px!important}.clause-summary h2{font-size:17px;line-height:1.35;overflow-wrap:anywhere}.clause-score{width:100%;min-width:0!important;text-align:left!important}.major-clause{flex-direction:column!important;align-items:stretch!important;gap:12px!important;padding:15px!important}.major-clause>div:last-child{width:100%;min-width:0!important;text-align:left!important}.q{grid-template-columns:1fr;padding:15px;border-radius:13px}.num{width:max-content;margin-bottom:8px;padding:4px 8px;border-radius:7px;background:#f0f4f1;color:#687871}.q h2{font-size:15px;line-height:1.45}.answers{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));width:100%;gap:6px}.answers button{width:100%;min-width:0;min-height:42px;padding:8px 5px;border-radius:8px}.finding-slot{grid-column:1/-1;margin:0!important}.open{display:flex;justify-content:center;width:100%;min-height:42px;margin:0;align-items:center}.chart-title,.fishhead{display:flex;flex-wrap:wrap;gap:10px}.chart-title>div{flex:1 1 220px;min-width:0}.column-chart{width:100%;height:225px;margin-top:17px;padding-inline:2px;overflow-x:auto;overscroll-behavior-x:contain;scrollbar-width:thin}.chart-column{min-width:28px}table:not(.smart-table),table:not(.smart-table) tbody,table:not(.smart-table) tr,table:not(.smart-table) td{display:block;width:100%}table:not(.smart-table) thead{display:none}table:not(.smart-table) tbody{display:grid;gap:10px;padding-top:7px}table:not(.smart-table) tr{overflow:hidden;border:1px solid #e2e8e4;border-radius:11px;background:#fff}table:not(.smart-table) td{display:grid;grid-template-columns:82px minmax(0,1fr);align-items:center;gap:8px;min-width:0;padding:10px 12px;border-top:1px solid #e2e8e4}table:not(.smart-table) td:before{color:#6d7b75;font-size:9px;font-weight:800;letter-spacing:.08em;text-transform:uppercase}table:not(.smart-table) td:first-child{display:block;border-top:0;background:#f8faf8}table:not(.smart-table) td:first-child:before{display:none}table:not(.smart-table) td:nth-child(2):before{content:"Priority"}table:not(.smart-table) td:nth-child(3):before{content:"Owner"}table:not(.smart-table) td:nth-child(4):before{content:"Due date"}table:not(.smart-table) td:nth-child(5):before{content:"Status"}.hero{padding:16px;border-radius:13px}.hero blockquote{display:grid;grid-template-columns:minmax(0,1fr) auto;align-items:start;gap:10px;line-height:1.5}.hero blockquote b{padding:6px 8px;border-radius:7px;background:#471f1e}.stack{gap:10px}.fish{padding:16px}.fishhead{align-items:flex-start}.live{flex:0 0 auto}.detail{line-height:1.45}.smart-table-wrap{overflow:visible!important;border:0!important;background:transparent!important}.smart-table,.smart-table tbody,.smart-table tr,.smart-table th,.smart-table td{display:block;width:100%;min-width:0!important}.smart-table thead{display:none}.smart-table tbody tr{overflow:hidden;border:1px solid #bfdbce;border-radius:11px;background:#fff}.smart-table tbody th,.smart-table tbody td{display:grid;grid-template-columns:105px minmax(0,1fr);gap:9px;padding:11px 12px!important;border-bottom:1px solid #dcebe4!important;overflow-wrap:anywhere}.smart-table tbody th:before,.smart-table tbody td:before{color:#0b7251;font-size:9px;font-weight:800;letter-spacing:.05em;text-transform:uppercase}.smart-table tbody th:before{content:"S/N"}.smart-table tbody td:nth-child(2):before{content:"Objectives"}.smart-table tbody td:nth-child(3):before{content:"Target"}.smart-table tbody td:nth-child(4):before{content:"Timeline"}.smart-table tbody td:nth-child(5):before{content:"Action plan"}.smart-table tbody td:nth-child(6):before{content:"Responsible"}.smart-table tbody td:nth-child(7):before{content:"Monitoring"}.smart-table tbody td:nth-child(8):before{content:"Status"}}@media(max-width:520px){.fishstage{grid-template-columns:1fr!important}}@media(max-width:410px){.brand span{display:none!important}.head h1{font-size:24px}}`;
...
function shell(path, title, subtitle, body) {
  return `<!doctype html><html><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>${title}</title><style>${style}</style></head><body><div class="shell"><aside class="side"><a href="/" class="brand"><i>◈</i><span style="display:inline-block;max-width:145px;font-size:13px;line-height:1.35;vertical-align:middle">Quality Management<br>System</span></a><nav class="nav"><small>Workspace</small><a class="${path === "/" || path === "/dashboard" ? "on" : ""}" href="/">◫ &nbsp; Dashboard</a><a class="${path === "/audit" ? "on" : ""}" href="/audit">▣ &nbsp; Audit</a></nav><div class="foot">● Developed by<br><strong>D2A2I</strong></div></aside><main class="main"><header class="head"><div><span class="kicker">ISO 9001:2015 Standard</span><h1>${title}</h1><p>${subtitle}</p></div></header>${body}</main></div><style>${mobileStyle}</style><script>${stateScriptV2}</script></body></html>`;
}
function audit() {
  let qs = questions
    .map(
